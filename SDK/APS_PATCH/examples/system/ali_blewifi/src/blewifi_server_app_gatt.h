...
enum
{
    ...
    ALI_IDX_DATA_READ_CHAR,
    ALI_IDX_DATA_READ_VAL,

    ALI_IDX_DATA_WRITE_CHAR,
    ALI_IDX_DATA_WRITE_VAL,

    ALI_IDX_DATA_INDICATE_CHAR,
    ALI_IDX_DATA_INDICATE_VAL,
    ALI_IDX_DATA_INDICATE_CFG,

    ALI_IDX_DATA_WWNRC_CHAR,
    ALI_IDX_DATA_WWNRC_VAL,

    ALI_IDX_DATA_NOTIFY_CHAR,
    ALI_IDX_DATA_NOTIFY_VAL,
    ALI_IDX_DATA_NOTIFY_CFG,
