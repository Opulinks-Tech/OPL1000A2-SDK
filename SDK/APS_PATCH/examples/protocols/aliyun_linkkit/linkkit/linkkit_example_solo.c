...
extern E_GpioIdx_t g_gpioid_23;
...
#else
/* Opulinks SamrtLight Ref. */
#define PRODUCT_KEY      "a2qt9kUYqUQ"
#define PRODUCT_SECRET   "mDvYTXeX8N3pYLtz"
#define DEVICE_NAME      "SmartLightRef"
#define DEVICE_SECRET    "6FqUVeUxibukPjFlvWYU5jCbLoanjYvu"
#endif
...
//LED control
int green_led=0;
static void green_led_set(bool val)
{
     if(val==true)
     {
            Hal_Vic_GpioOutput(g_gpioid_23,GPIO_LEVEL_HIGH);
     }
     else
     {
            Hal_Vic_GpioOutput(g_gpioid_23,GPIO_LEVEL_LOW);
     }
}
