...
const dm_server_uri_map_t g_dm_server_uri_map[4] = {
...
void dump_dm_server_uri_map(void)
{
    printf("%s\n", g_dm_server_uri_map[0].uri_name);
    printf("%s\n", g_dm_server_uri_map[1].uri_name);
    printf("%s\n", g_dm_server_uri_map[2].uri_name);
    printf("%s\n", g_dm_server_uri_map[3].uri_name);
}
