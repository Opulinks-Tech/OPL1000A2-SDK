...
#define MBEDTLS_SSL_MAX_CONTENT_LEN(L)         16384   /**< Size of the input / output buffer */
#endif

#if !defined(MBEDTLS_SSL_IN_CONTENT_LEN)
#define MBEDTLS_SSL_IN_CONTENT_LEN MBEDTLS_SSL_MAX_CONTENT_LEN(0)
#endif

#if !defined(MBEDTLS_SSL_OUT_CONTENT_LEN)
#define MBEDTLS_SSL_OUT_CONTENT_LEN MBEDTLS_SSL_MAX_CONTENT_LEN(0)
#endif

extern int mbedtls_ssl_max_content_len;
...
/**
 * \brief          Configurate Maximum fragment length in byte
 * \note           Determines the size of both the incoming and outgoing TLS I/O buffers.
 *
 * \param conf     Maximum fragment length
 */
void mbedtls_ssl_config_max_content_len(int max_content_len);
