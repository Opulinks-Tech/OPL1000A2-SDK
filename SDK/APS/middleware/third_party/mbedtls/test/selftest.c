...
#define LOG_I(fmt,arg...)             printf(("[mbedTLS]: "fmt"\r\n"), ##arg)
...
int tls_selftest_main( int argc, char *argv[] )
{
    ...
    if( pointer != NULL )
    {
        LOG_I("all-bits-zero is not a NULL pointer\n" );
        return( -1 );
    }
    ...
    //{
    //    LOG_I("The snprintf implementation is broken\n" );
    //    return( 0 );
    //}
...
#else
    LOG_I(" MBEDTLS_SELF_TEST not defined.\n" );
#endif
