...
#ifdef MBEDTLS_OPL
const int *g_ciphersuite_preference_table_ptr = NULL;

void mbedtls_ssl_setup_preference_ciphersuites(const int *ciphersuites)
{
    g_ciphersuite_preference_table_ptr = ciphersuites;
}
#endif
...
#ifdef MBEDTLS_OPL
const int *mbedtls_ssl_list_ciphersuites_impl( void )
{
    /*
...
const int *mbedtls_ssl_list_ciphersuites( void )
{
    if (g_ciphersuite_preference_table_ptr == NULL)
    {
        return (mbedtls_ssl_list_ciphersuites_impl());
    }
    else
    {
        return g_ciphersuite_preference_table_ptr;
    }
}
