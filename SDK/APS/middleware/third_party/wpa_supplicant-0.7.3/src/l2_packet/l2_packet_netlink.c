...
struct l2_packet_data * l2_packet_init_impl(
...
void l2_packet_deinit_impl(struct l2_packet_data *l2)
{
	if (l2 == NULL)
		return;
...
RET_DATA l2_packet_init_fp_t l2_packet_init;
RET_DATA l2_packet_deinit_fp_t l2_packet_deinit;
...
{
    l2_packet_init = l2_packet_init_impl;
    l2_packet_deinit = l2_packet_deinit_impl;
}
