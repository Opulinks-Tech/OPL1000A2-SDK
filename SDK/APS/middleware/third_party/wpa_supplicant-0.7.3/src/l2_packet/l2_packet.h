...
typedef struct l2_packet_data * (*l2_packet_init_fp_t)(const char *ifname, const u8 *own_addr, unsigned short protocol, void (*rx_callback)(void *ctx, const u8 *src_addr, const u8 *buf, size_t len), void *rx_callback_ctx, int l2_hdr);
typedef void (*l2_packet_deinit_fp_t)(struct l2_packet_data *l2);

extern l2_packet_init_fp_t l2_packet_init;
extern l2_packet_deinit_fp_t l2_packet_deinit;


/*
   Interface Initialization: WPA L2 Packet
 */
void wpa_l2_packet_func_init(void);
