...
void wpas_notify_suspend_impl(struct wpa_global *global)
{
...
void wpas_notify_resume_impl(struct wpa_global *global)
{
	struct os_time now;
	int slept = 0;
	struct wpa_supplicant *wpa_s;
...
RET_DATA wpas_notify_suspend_fp_t wpas_notify_suspend;
RET_DATA wpas_notify_resume_fp_t wpas_notify_resume;


/*
   Interface Initialization: WPA Notify
 */
void wpa_notify_func_init(void)
{
    wpas_notify_suspend = wpas_notify_suspend_impl;
    wpas_notify_resume = wpas_notify_resume_impl;
}
