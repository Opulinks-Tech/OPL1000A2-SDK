...
typedef const u8 * (*wpa_bss_get_ie_fp_t)(const struct wpa_bss *bss, u8 ie);
typedef const u8 * (*wpa_bss_get_vendor_ie_fp_t)(const struct wpa_bss *bss, u32 vendor_type);


extern wpa_bss_get_ie_fp_t wpa_bss_get_ie;
extern wpa_bss_get_vendor_ie_fp_t wpa_bss_get_vendor_ie;
