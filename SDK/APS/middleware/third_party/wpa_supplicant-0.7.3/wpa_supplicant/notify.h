...
typedef void (*wpas_notify_suspend_fp_t)(struct wpa_global *global);
typedef void (*wpas_notify_resume_fp_t)(struct wpa_global *global);

extern wpas_notify_suspend_fp_t wpas_notify_suspend;
extern wpas_notify_resume_fp_t wpas_notify_resume;
