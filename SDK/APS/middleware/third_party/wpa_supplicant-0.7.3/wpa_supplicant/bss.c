...
const u8 * wpa_bss_get_ie_impl(const struct wpa_bss *bss, u8 ie)
{
	const u8 *end, *pos;
...
const u8 * wpa_bss_get_vendor_ie_impl(const struct wpa_bss *bss, u32 vendor_type)
{
	const u8 *end, *pos;
...
RET_DATA wpa_bss_get_ie_fp_t wpa_bss_get_ie;
RET_DATA wpa_bss_get_vendor_ie_fp_t wpa_bss_get_vendor_ie;


/*
   Interface Initialization: WPA BSS
 */
void wpa_bss_func_init(void)
{
    wpa_bss_get_ie = wpa_bss_get_ie_impl;
    wpa_bss_get_vendor_ie = wpa_bss_get_vendor_ie_impl;
}
...
void wpa_bss_add(struct wpa_supplicant *wpa_s,
			const u8 *ssid, size_t ssid_len,
...
void wpa_bss_update(struct wpa_supplicant *wpa_s, struct wpa_bss *bss,
			   struct wpa_scan_res *res)
{
	u32 changes;
...
int wpa_bss_in_use(struct wpa_supplicant *wpa_s, struct wpa_bss *bss)
{
...
int wpa_bss_included_in_scan(const struct wpa_bss *bss,
...
void wpa_bss_timeout(void *eloop_ctx, void *timeout_ctx)
{
...
#if 0
int are_ies_equal(const struct wpa_bss *old,
