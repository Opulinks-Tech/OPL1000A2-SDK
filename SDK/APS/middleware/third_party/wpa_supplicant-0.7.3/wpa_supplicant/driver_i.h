...
//static inline int wpa_drv_disassociate(struct wpa_supplicant *wpa_s, const u8 *addr, int reason_code)
...
//static inline int wpa_drv_send_eapol(struct wpa_supplicant *wpa_s, const u8 *dst, u16 proto, const u8 *data, size_t data_len)
#if 0
...
//static inline int wpa_drv_set_channel(struct wpa_supplicant *wpa_s, enum hostapd_hw_mode phymode, int chan,int freq)
...
//static inline int wpa_drv_set_ssid(struct wpa_supplicant *wpa_s, const u8 *ssid, size_t ssid_len)
...
//static inline int wpa_drv_set_bssid(struct wpa_supplicant *wpa_s, const u8 *bssid)
...
//static inline int wpa_drv_send_mlme(struct wpa_supplicant *wpa_s, const u8 *data, size_t data_len)
...
//static inline int wpa_drv_mlme_add_sta(struct wpa_supplicant *wpa_s, const u8 *addr, const u8 *supp_rates, size_t supp_rates_len)
...
//static inline int wpa_drv_mlme_remove_sta(struct wpa_supplicant *wpa_s, const u8 *addr)
...
//static inline int wpa_drv_send_ft_action(struct wpa_supplicant *wpa_s,u8 action, const u8 *target_ap,const u8 *ies, size_t ies_len)
...
//static inline int wpa_drv_set_beacon(struct wpa_supplicant *wpa_s,const u8 *head, size_t head_len,const u8 *tail, size_t tail_len,int dtim_period, int beacon_int)
...
//static inline int wpa_drv_hapd_send_eapol(struct wpa_supplicant *wpa_s,const u8 *addr, const u8 *data,size_t data_len, int encrypt,const u8 *own_addr)
...
//static inline int wpa_drv_send_action(struct wpa_supplicant *wpa_s, unsigned int freq, const u8 *dst, const u8 *src, const u8 *bssid, const u8 *data, size_t data_len)
...
//static inline int wpa_drv_if_add(struct wpa_supplicant *wpa_s, enum wpa_driver_if_type type, const char *ifname, const u8 *addr, void *bss_ctx, char *force_ifname, u8 *if_addr)
...
static int wpa_drv_cancel_remain_on_channel(
...
//static inline int wpa_drv_disable_11b_rates(struct wpa_supplicant *wpa_s, int disabled)
...
//static inline int wpa_drv_set_ap_wps_ie(struct wpa_supplicant *wpa_s,const struct wpabuf *beacon,const struct wpabuf *proberesp)
