...
char * wpa_config_write_string_ascii(const u8 *value, size_t len)
{
	char *buf;
...
char * wpa_config_write_string(const u8 *value, size_t len)
{
	if (value == NULL)
		return NULL;
...
char * wpa_config_write_str(const struct parse_data *data,
				   struct wpa_ssid *ssid)
{
	size_t len;
	char **src;
...
int wpa_config_parse_int(const struct parse_data *data,
				struct wpa_ssid *ssid,
				int line, const char *value)
{
	int *dst;
...
#ifndef NO_CONFIG_WRITE
char * wpa_config_write_int(const struct parse_data *data,
				   struct wpa_ssid *ssid)
{
	int *src, res;
	char *value;
...
int wpa_config_parse_bssid(const struct parse_data *data,
...
#ifndef NO_CONFIG_WRITE
char * wpa_config_write_bssid(const struct parse_data *data,
				     struct wpa_ssid *ssid)
{
	char *value;
	int res;
...
int wpa_config_parse_psk(const struct parse_data *data,
				struct wpa_ssid *ssid, int line,
				const char *value)
{
	if (*value == '"') {
...
#ifndef NO_CONFIG_WRITE
char * wpa_config_write_psk(const struct parse_data *data,
				   struct wpa_ssid *ssid)
{
	if (ssid->passphrase)
...
int wpa_config_parse_proto(const struct parse_data *data,
				  struct wpa_ssid *ssid, int line,
				  const char *value)
{
...
#ifndef NO_CONFIG_WRITE
char * wpa_config_write_proto(const struct parse_data *data,
				     struct wpa_ssid *ssid)
{
	int first = 1, ret;
	char *buf, *pos, *end;
...
int wpa_config_parse_key_mgmt(const struct parse_data *data,
				     struct wpa_ssid *ssid, int line,
				     const char *value)
{
	int val = 0, last, errors = 0;
...
#ifndef NO_CONFIG_WRITE
char * wpa_config_write_key_mgmt(const struct parse_data *data,
					struct wpa_ssid *ssid)
{
	char *buf, *pos, *end;
	int ret;
...
int wpa_config_parse_cipher(int line, const char *value)
{
	int val = 0, last;
	char *start, *end, *buf;
...
#ifndef NO_CONFIG_WRITE
char * wpa_config_write_cipher(int cipher)
{
	char *buf, *pos, *end;
	int ret;
...
int wpa_config_parse_pairwise(const struct parse_data *data,
				     struct wpa_ssid *ssid, int line,
				     const char *value)
{
	int val;
...
#ifndef NO_CONFIG_WRITE
char * wpa_config_write_pairwise(const struct parse_data *data,
					struct wpa_ssid *ssid)
{
...
int wpa_config_parse_group(const struct parse_data *data,
				  struct wpa_ssid *ssid, int line,
				  const char *value)
{
	int val;
...
#ifndef NO_CONFIG_WRITE
char * wpa_config_write_group(const struct parse_data *data,
				     struct wpa_ssid *ssid)
{
...
int wpa_config_parse_auth_alg(const struct parse_data *data,
				     struct wpa_ssid *ssid, int line,
				     const char *value)
{
	int val = 0, last, errors = 0;
...
#ifndef NO_CONFIG_WRITE
char * wpa_config_write_auth_alg(const struct parse_data *data,
					struct wpa_ssid *ssid)
{
	char *buf, *pos, *end;
	int ret;
...
int * wpa_config_parse_freqs(const struct parse_data *data,
				    struct wpa_ssid *ssid, int line,
				    const char *value)
{
	int *freqs;
...
int wpa_config_parse_scan_freq(const struct parse_data *data,
				      struct wpa_ssid *ssid, int line,
				      const char *value)
{
	int *freqs;
...
int wpa_config_parse_freq_list(const struct parse_data *data,
				      struct wpa_ssid *ssid, int line,
				      const char *value)
{
	int *freqs;
...
#ifndef NO_CONFIG_WRITE
char * wpa_config_write_freqs(const struct parse_data *data,
				     const int *freqs)
{
	char *buf, *pos, *end;
	int i, ret;
...
char * wpa_config_write_scan_freq(const struct parse_data *data,
					 struct wpa_ssid *ssid)
{
...
char * wpa_config_write_freq_list(const struct parse_data *data,
					 struct wpa_ssid *ssid)
{
...
char * wpa_config_write_eap(const struct parse_data *data,
				   struct wpa_ssid *ssid)
{
	int i, ret;
	char *buf, *pos, *end;
...
int wpa_config_parse_password(const struct parse_data *data,
				     struct wpa_ssid *ssid, int line,
				     const char *value)
{
	u8 *hash;
...
char * wpa_config_write_password(const struct parse_data *data,
					struct wpa_ssid *ssid)
{
	char *buf;
...
int wpa_config_parse_wep_key(u8 *key, size_t *len, int line,
...
int wpa_config_parse_wep_key0(const struct parse_data *data,
				     struct wpa_ssid *ssid, int line,
				     const char *value)
{
...
int wpa_config_parse_wep_key1(const struct parse_data *data,
				     struct wpa_ssid *ssid, int line,
				     const char *value)
{
...
int wpa_config_parse_wep_key2(const struct parse_data *data,
				     struct wpa_ssid *ssid, int line,
				     const char *value)
{
...
int wpa_config_parse_wep_key3(const struct parse_data *data,
				     struct wpa_ssid *ssid, int line,
				     const char *value)
{
...
#ifndef NO_CONFIG_WRITE
char * wpa_config_write_wep_key(struct wpa_ssid *ssid, int idx)
{
...
char * wpa_config_write_wep_key0(const struct parse_data *data,
					struct wpa_ssid *ssid)
{
...
char * wpa_config_write_wep_key1(const struct parse_data *data,
					struct wpa_ssid *ssid)
{
...
char * wpa_config_write_wep_key2(const struct parse_data *data,
					struct wpa_ssid *ssid)
{
...
char * wpa_config_write_wep_key3(const struct parse_data *data,
					struct wpa_ssid *ssid)
{
...
#ifdef IEEE8021X_EAPOL
void eap_peer_config_free(struct eap_peer_config *eap)
{
					   ...
					   const char *driver_param)
{
    ...
    //Michael Liao debug, need to modify here with the correct settings for open system connection
