...
#if 0
//void ieee80211_send_probe_req(struct wpa_supplicant *wpa_s, const u8 *dst, const u8 *ssid, size_t ssid_len);
//struct ieee80211_sta_bss * ieee80211_bss_get(struct wpa_supplicant *wpa_s, const u8 *bssid);
//int ieee80211_sta_find_ibss(struct wpa_supplicant *wpa_s);
//int ieee80211_sta_wep_configured(struct wpa_supplicant *wpa_s);
//void ieee80211_sta_timer(void *eloop_ctx, void *timeout_ctx);
//void ieee80211_sta_scan_timer(void *eloop_ctx, void *timeout_ctx);
//int ieee80211_sta_set_probe_req_ie(struct wpa_supplicant *wpa_s, const u8 *ies, size_t ies_len);
#endif

#if 0
int ieee80211_sta_set_channel(struct wpa_supplicant *wpa_s,
...
void ieee80211_sta_wmm_params(struct wpa_supplicant *wpa_s,
...
void ieee80211_set_associated(struct wpa_supplicant *wpa_s, int assoc)
{
...
int ieee80211_sta_tx(struct wpa_supplicant *wpa_s, const u8 *buf,
			    size_t len)
{
...
void ieee80211_send_auth(struct wpa_supplicant *wpa_s,
...
void ieee80211_reschedule_timer(struct wpa_supplicant *wpa_s, int ms)
{
...
void ieee80211_authenticate(struct wpa_supplicant *wpa_s)
{
	u8 *extra;
	size_t extra_len;
...
void ieee80211_send_assoc(struct wpa_supplicant *wpa_s)
{
	struct ieee80211_mgmt *mgmt;
	u8 *pos, *ies, *buf;
	int i, len;
...
void ieee80211_send_deauth(struct wpa_supplicant *wpa_s, u16 reason)
{
	u8 *buf;
	size_t len;
	struct ieee80211_mgmt *mgmt;
...
void ieee80211_send_disassoc(struct wpa_supplicant *wpa_s, u16 reason)
{
	u8 *buf;
	size_t len;
	struct ieee80211_mgmt *mgmt;
...
int ieee80211_privacy_mismatch(struct wpa_supplicant *wpa_s)
{
	struct ieee80211_sta_bss *bss;
	int res = 0;
...
void ieee80211_associate(struct wpa_supplicant *wpa_s)
{
...
void ieee80211_associated(struct wpa_supplicant *wpa_s)
{
	int disassoc;
...
void ieee80211_send_probe_req(struct wpa_supplicant *wpa_s,
				     const u8 *dst,
...
void ieee80211_auth_completed(struct wpa_supplicant *wpa_s)
{
...
void ieee80211_auth_challenge(struct wpa_supplicant *wpa_s,
				     struct ieee80211_mgmt *mgmt,
				     size_t len,
...
void ieee80211_rx_mgmt_auth(struct wpa_supplicant *wpa_s,
				   struct ieee80211_mgmt *mgmt,
				   size_t len,
				   struct ieee80211_rx_status *rx_status)
{
...
void ieee80211_rx_mgmt_deauth(struct wpa_supplicant *wpa_s,
				     struct ieee80211_mgmt *mgmt,
				     size_t len,
				     struct ieee80211_rx_status *rx_status)
{
...
void ieee80211_rx_mgmt_disassoc(struct wpa_supplicant *wpa_s,
				       struct ieee80211_mgmt *mgmt,
				       size_t len,
				       struct ieee80211_rx_status *rx_status)
{
...
void ieee80211_rx_mgmt_assoc_resp(struct wpa_supplicant *wpa_s,
					 struct ieee80211_mgmt *mgmt,
					 size_t len,
					 struct ieee80211_rx_status *rx_status,
					 int reassoc)
...
void __ieee80211_bss_hash_add(struct wpa_supplicant *wpa_s,
				     struct ieee80211_sta_bss *bss)
{
...
/* Caller must hold local->sta_bss_lock */
void __ieee80211_bss_hash_del(struct wpa_supplicant *wpa_s,
				     struct ieee80211_sta_bss *bss)
{
...
void ieee80211_bss_free(struct wpa_supplicant *wpa_s,
			       struct ieee80211_sta_bss *bss)
{
...
void ieee80211_bss_list_deinit(struct wpa_supplicant *wpa_s)
{
...
void ieee80211_bss_info(struct wpa_supplicant *wpa_s,
			       struct ieee80211_mgmt *mgmt,
			       size_t len,
			       struct ieee80211_rx_status *rx_status,
			       int beacon)
...
void ieee80211_rx_mgmt_probe_resp(struct wpa_supplicant *wpa_s,
					 struct ieee80211_mgmt *mgmt,
					 size_t len,
					 struct ieee80211_rx_status *rx_status)
{
...
void ieee80211_rx_mgmt_beacon(struct wpa_supplicant *wpa_s,
				     struct ieee80211_mgmt *mgmt,
				     size_t len,
				     struct ieee80211_rx_status *rx_status)
{
...
void ieee80211_rx_mgmt_probe_req(struct wpa_supplicant *wpa_s,
					struct ieee80211_mgmt *mgmt,
					size_t len,
					struct ieee80211_rx_status *rx_status)
{
...
void dump_tspec(struct wmm_tspec_element *tspec)
{
	int up, psb, dir, tid;
	u16 val;
...
int is_wmm_tspec(const u8 *ie, size_t len)
{
...
void ieee80211_rx_mgmt_wmm_action(
	struct wpa_supplicant *wpa_s, struct ieee80211_mgmt *mgmt, size_t len,
	struct ieee80211_rx_status *rx_status)
{
	size_t alen;
...
void ieee80211_rx_mgmt_action(struct wpa_supplicant *wpa_s,
				     struct ieee80211_mgmt *mgmt,
				     size_t len,
				     struct ieee80211_rx_status *rx_status)
{
...
void ieee80211_sta_rx_mgmt(struct wpa_supplicant *wpa_s,
...
void ieee80211_sta_rx_scan(struct wpa_supplicant *wpa_s,
				  const u8 *buf, size_t len,
				  struct ieee80211_rx_status *rx_status)
{
	struct ieee80211_mgmt *mgmt;
...
int ieee80211_sta_active_ibss(struct wpa_supplicant *wpa_s)
{
	int active = 0;
...
void ieee80211_sta_expire(struct wpa_supplicant *wpa_s)
{
#if 0 /* FIX */
...
void ieee80211_sta_merge_ibss(struct wpa_supplicant *wpa_s)
{
...
void ieee80211_sta_new_auth(struct wpa_supplicant *wpa_s)
{
	struct wpa_ssid *ssid = wpa_s->current_ssid;
...
int ieee80211_ibss_allowed(struct wpa_supplicant *wpa_s)
{
#if 0 /* FIX */
	int m, c;
...
int ieee80211_sta_join_ibss(struct wpa_supplicant *wpa_s,
				   struct ieee80211_sta_bss *bss)
{
...
void ieee80211_sta_save_oper_chan(struct wpa_supplicant *wpa_s)
{
...
int ieee80211_sta_restore_oper_chan(struct wpa_supplicant *wpa_s)
{
...
int ieee80211_active_scan(struct wpa_supplicant *wpa_s)
{
	size_t m;
	int c;
...
int ieee80211_sta_set_probe_req_ie(struct wpa_supplicant *wpa_s,
...
//void ieee80211_build_tspec(struct wpabuf *buf);
#if 0 /* FIX */
...
#if 0 /* FIX */
int ieee80211_sta_create_ibss(struct wpa_supplicant *wpa_s)
{
	struct ieee80211_sta_bss *bss;
...
#if 0
void ieee80211_tx_addts(struct wpa_supplicant *wpa_s)
{
	struct wpabuf *buf;
	struct ieee80211_mgmt *mgmt;
	size_t alen;
