...
extern int wifi_debug_level;
extern int wifi_debug_show_keys;
extern int wifi_debug_timestamp;
...
#define wifi_printf(args...) do { } while (0)
#define wifi_hexdump(l,t,b,le) do { } while (0)
#define wifi_hexdump_buf(l,t,b) do { } while (0)
#define wifi_hexdump_key(l,t,b,le) do { } while (0)
#define wifi_hexdump_buf_key(l,t,b) do { } while (0)
#define wifi_hexdump_ascii(l,t,b,le) do { } while (0)
#define wifi_hexdump_ascii_key(l,t,b,le) do { } while (0)
#define wifi_debug_open_file(p) do { } while (0)
#define wifi_debug_close_file() do { } while (0)
#define wifi_debug_setup_stdout() do { } while (0)
#define wifi_dbg(args...) do { } while (0)
...
/**
 * wifi_printf - conditional printf
 ...
 */
//void wifi_printf(int level, char *fmt, ...);

#define wifi_printf(level, _message, ...) \
    do { \
        if (level >= wifi_debug_level) \
        {    \
            msg_print(LOG_HIGH_LEVEL, (_message), ##__VA_ARGS__); \
        }    \
    } while (0)
 ...
 */
void wifi_hexdump(int level, const char *title, const void *buf, size_t len);


/**
 * wifi_hexdump_key - conditional hex dump, hide keys
 * @level: priority level (MSG_*) of the message
 * @title: title of for the message
 * @buf: data buffer to be dumped
 * @len: length of the buf
 ...
 * etc.) in debug output.
 */
void wifi_hexdump_key(int level, const char *title, const void *buf, size_t len);

/*
 * wifi_dbg() behaves like wpa_msg(), but it can be removed from build to reduce
