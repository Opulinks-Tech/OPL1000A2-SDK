...
void vTaskRestartScheduler( void ) PRIVILEGED_FUNCTION;
...
void xTaskGetTickCountEx( TickType_t *pxTicks, BaseType_t *pxOverflows ) PRIVILEGED_FUNCTION;
...
void xTaskGetTickCountFromISREx( TickType_t *pxTicks, BaseType_t *pxOverflows ) PRIVILEGED_FUNCTION;
...
TickType_t vTaskNextUnblockTime(void) PRIVILEGED_FUNCTION;
